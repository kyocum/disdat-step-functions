...
class Caching:
    ...
    def cache_step(self, user_step: steps.states, bundle_name: str = None, fore_rerun: bool = False) -> steps.Chain:
        """
        ...
        :param fore_rerun: bool, override the object-level force rerun setting
        ...
        disdat_args['force_rerun'] = fore_rerun
